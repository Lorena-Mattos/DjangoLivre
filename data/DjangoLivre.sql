...
CREATE TABLE `transactions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `type_transaction` enum('PIX','TED','DOC') DEFAULT NULL,
  `id_conta_recebedor` int DEFAULT NULL,
  `id_conta_pagador` int DEFAULT NULL,
  `valor` float DEFAULT NULL,
  `data` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `id_conta_recebedor` (`id_conta_recebedor`),
  KEY `id_conta_pagador` (`id_conta_pagador`),
  CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`id_conta_recebedor`) REFERENCES `client` (`id`),
  CONSTRAINT `transactions_ibfk_2` FOREIGN KEY (`id_conta_pagador`) REFERENCES `client` (`id`)
...
-- Dump completed on 2021-11-27 17:03:58
